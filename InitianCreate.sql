...
-- Création de la table Pokemon_Dresseur pour gérer les relations N-M entre Pokemon et Dresseur
CREATE TABLE Pokemon_Dresseur (
    idPokemon INT,
    idDresseur INT,
    PRIMARY KEY (idPokemon, idDresseur),
    CONSTRAINT fk_Pokemon FOREIGN KEY (idPokemon) REFERENCES Pokemon(idPokemon),
    CONSTRAINT fk_Dresseur FOREIGN KEY (idDresseur) REFERENCES Dresseur(idDresseur)
);

-- Création de la table PokemonType pour gérer les types multiples pour un Pokemon
CREATE TABLE PokemonType (
    idPokemon INT,
    idType INT,
    PRIMARY KEY (idPokemon, idType),
    CONSTRAINT fk_Pokemon_type FOREIGN KEY (idPokemon) REFERENCES Pokemon(idPokemon),
